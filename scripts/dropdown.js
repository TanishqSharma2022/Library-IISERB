...

  {
    ...
    options: [
      ...
      },
      {
        ...
        link: "https://research.iiserb.ac.in/pages/publications",
      },
      {
...
dropDown.forEach((item, index) => {
  ...
  dropDownItem.innerHTML = `
      <span class="flex z-[9999999] shadow-sm p-4 transition duration-500ms   w-full border-b border-zinc-400 hover:bg-gray-300 items-center justify-between cursor-pointer  gap-4 " onclick="toggleMobileDropdown(${index})">
